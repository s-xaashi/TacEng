...
drop policy if exists "Admins can manage ads" on public.ad_campaigns;
...
drop policy if exists "Public can read active ad form fields" on public.ad_form_fields;
...
drop policy if exists "Admins can manage ad form fields" on public.ad_form_fields;
...
drop policy if exists "Admins can read ad submissions" on public.ad_submissions;
...
drop policy if exists "Public can record ad events" on public.ad_events;
