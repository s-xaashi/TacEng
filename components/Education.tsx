...
type LearningItem = { id:string; section_label:string|null; title:string; degree:string|null; period:string|null; status:string|null; description:string|null; color:string; sort_order:number; published:boolean };
